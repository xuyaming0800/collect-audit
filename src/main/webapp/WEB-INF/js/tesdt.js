...
(function (e, t) {
    ...
    function i(e, n, r, i) {
        if (ut.acceptData(e)) {
            var s, o, u = ut.expando,
                ...
                l = f ? ut.cache : e,
                c = f ? e[u] : e[u] && u;
            if (c && l[c] && (i || l[c].data) || !a || r !== t) return c || (f ? e[u] = c = Y.pop() || ut.guid++ : c = u),
    ...
    function x(e, t) {
        for (var n, r = [], i = 0, s = e.length; s > i; i++) n = e[i],
        n.style && (r[i] = ut._data(n, "olddisplay"), t ? (r[i] || "none" !== n.style.display || (n.style.display = ""), "" === n.style.display && S(n) && (r[i] = ut._data(n, "olddisplay", k(n.nodeName)))) : r[i] || S(n) || ut._data(n, "olddisplay", ut.css(n, "display")));
        for (i = 0; s > i; i++) n = e[i],
    ...
    function N(e, t, n, r, i) {
        for (var s = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, o = 0; 4 > s; s += 2)"margin" === n && (o += ut.css(e, n + Sn[s], !0, i)),
        r ? ("content" === n && (o -= ut.css(e, "padding" + Sn[s], !0, i)), "margin" !== n && (o -= ut.css(e, "border" + Sn[s] + "Width", !0, i))) : (o += ut.css(e, "padding" + Sn[s], !0, i), "padding" !== n && (o += ut.css(e, "border" + Sn[s] + "Width", !0, i)));
        return o
    }
    function C(e, t, n) {
        var r = !0,
    ...
    function k(e) {
        var t = $,
            n = bn[e];
        return n || (n = L(e, t), "none" !== n && n || (ln = (ln || ut("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement), t = (ln[0].contentWindow || ln[0].contentDocument).document, t.write("<!doctype html><html><body>"), t.close(), n = L(e, t), ln.detach()), bn[e] = n),
        n
    }
    function L(e, t) {
    ...
    function R(e, t, n) {
        ...
        n.queue || (l = ut._queueHooks(e, "fx"), null == l.unqueued && (l.unqueued = 0, c = l.empty.fire, l.empty.fire = function () {
                ...
                h.always(function () {
                    l.unqueued--,
                    ut.queue(e, "fx").length || l.empty.fire()
                })
            })),
        1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], "inline" === ut.css(e, "display") && "none" === ut.css(e, "float") && (ut.support.inlineBlockNeedsLayout && "inline" !== k(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")),
        n.overflow && (p.overflow = "hidden", ut.support.shrinkWrapBlocks || h.done(function () {
        ...
        if (o = v.length) {
                ...
                i in u || (u[i] = f.start, m && (f.end = f.start, f.start = "width" === i || "height" === i ? 1 : 0))
            }
    }
    ...
    ut.extend = ut.fn.extend = function () {
            var e, n, r, i, s, o, u = arguments[0] || {},
                ...
                f = arguments.length,
                l = !1;
            for ("boolean" == typeof u && (l = u, u = arguments[1] || {}, a = 2), "object" == typeof u || ut.isFunction(u) || (u = {}), f === a && (u = this, --a); f > a; a++) if (null != (e = arguments[a])) for (n in e) r = u[n],
            i = e[n],
            u !== i && (l && i && (ut.isPlainObject(i) || (s = ut.isArray(i))) ? (s ? (s = !1, o = r && ut.isArray(r) ? r : []) : o = r && ut.isPlainObject(r) ? r : {}, u[n] = ut.extend(l, o, i)) : i !== t && (u[n] = i));
            return u
        },
    ut.extend({
            noConflict: function (t) {
                return e.$ === ut && (e.$ = Q),
                t && e.jQuery === ut && (e.jQuery = K),
                ut
            },
            isReady: !1,
            readyWait: 1,
            ...
            ready: function (e) {
                if (e === !0 ? !--ut.readyWait : !ut.isReady) {
                    ...
                    ut.isReady = !0,
                    e !== !0 && --ut.readyWait > 0 || (V.resolveWith($, [ut]), ut.fn.trigger && ut($).trigger("ready").off("ready"))
                }
            },
            ...
            makeArray: function (e, t) {
                var r = t || [];
                return null != e && (n(Object(e)) ? ut.merge(r, "string" == typeof e ? [e] : e) : tt.call(r, e)),
                r
            },
            ...
            proxy: function (e, n) {
                ...
                ut.isFunction(e) ? (i = nt.call(arguments, 2), s = function () {
    ...
    ut.ready.promise = function (t) {
            ...
            else if ($.addEventListener) $.addEventListener("DOMContentLoaded", wt, !1),
                ...
                h = {
                    ...
                    remove: function () {
                        return f && ut.each(arguments, function (e, t) {
                            for (var n;
                            (n = ut.inArray(t, f, n)) > -1;) f.splice(n, 1),
                            s && (u >= n && u--, a >= n && a--)
                        }),
                        this
                    },
            ...
            data: function (e, n) {
                ...
                if (e === t) {
                        if (this.length && (a = ut.data(s), 1 === s.nodeType && !ut._data(s, "parsedAttrs"))) {
                            for (r = s.attributes; r.length > u; u++) i = r[u].name,
                            i.indexOf("data-") || (i = ut.camelCase(i.substring(5)), o(s, i, a[i]));
    ...
    ut.fn.extend({
            ...
            promise: function (e, n) {
                ...
                for ("string" != typeof e && (n = e, e = t), e = e || "fx"; u--;) r = ut._data(o[u], e + "queueHooks"),
    ...
    ut.fn.extend({
            ...
            toggleClass: function (e, t) {
                ...
                return ut.isFunction(e) ? this.each(function (n) {
                        ...
                        if ("string" === n) for (var i, s = 0, o = ut(this), u = t, a = e.match(ft) || []; i = a[s++];) u = r ? u : !o.hasClass(i),
            ...
            val: function (e) {
                var n, r, i, s = this[0];
                if (arguments.length) return i = ut.isFunction(e),
                ...
                if (s) return n = ut.valHooks[s.type] || ut.valHooks[s.nodeName.toLowerCase()],
                n && "get" in n && (r = n.get(s, "value")) !== t ? r : (r = s.value, "string" == typeof r ? r.replace(kt, "") : null == r ? "" : r)
            }
        }),
    ut.extend({
            valHooks: {
            ...
            removeAttr: function (e, t) {
                var n, r, i = 0,
                    s = t && t.match(ft);
                if (s && 1 === e.nodeType) for (; n = s[i++];) r = ut.propFix[n] || n,
                Ot.test(n) ? !_t && Mt.test(n) ? e[ut.camelCase("default-" + n)] = e[r] = !1 : e[r] = !1 : ut.attr(e, n, ""),
            ...
            prop: function (e, n, r) {
                var i, s, o, u = e.nodeType;
                if (e && 3 !== u && 8 !== u && 2 !== u) return o = 1 !== u || !ut.isXMLDoc(e),
    ...
    Nt = {
            ...
            set: function (e, t, n) {
                return t === !1 ? ut.removeAttr(e, n) : Dt && _t || !Mt.test(n) ? e.setAttribute(!_t && ut.propFix[n] || n, n) : e[ut.camelCase("default-" + n)] = e[n] = !0,
                n
            }
        },
    ...
    ut.support.checkOn || ut.each(["radio", "checkbox"], function () {
            ut.valHooks[this] = {
                get: function (e) {
    ...
    ut.event = {
            ...
            add: function (e, n, r, i, s) {
                ...
                if (g) {
                    ...
                    }, u.elem = e), n = (n || "").match(ft) || [""], l = n.length; l--;) a = Ft.exec(n[l]) || [],
                    d = m = a[1],
                    v = (a[2] || "").split(".").sort(),
            ...
            remove: function (e, t, n, r, i) {
                ...
                if (m && (a = m.events)) {
                    for (t = (t || "").match(ft) || [""], f = t.length; f--;) if (u = Ft.exec(t[f]) || [], p = v = u[1], d = (u[2] || "").split(".").sort(), p) {
                        for (c = ut.event.special[p] || {}, p = (r ? c.delegateType : c.bindType) || p, h = a[p] || [], u = u[2] && RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), o = s = h.length; s--;) l = h[s],
            ...
            trigger: function (n, r, i, s) {
                ...
                if (u = a = i = i || $, 3 !== i.nodeType && 8 !== i.nodeType && !jt.test(d + ut.event.triggered) && (d.indexOf(".") >= 0 && (v = d.split("."), d = v.shift(), v.sort()), l = 0 > d.indexOf(":") && "on" + d, n = n[ut.expando] ? n : new ut.Event(d, "object" == typeof n && n), n.isTrigger = !0, n.namespace = v.join("."), n.namespace_re = n.namespace ? RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = t, n.target || (n.target = i), r = null == r ? [n] : ut.makeArray(r, [n]), h = ut.event.special[d] || {}, s || !h.trigger || h.trigger.apply(i, r) !== !1)) {
                        if (!s && !h.noBubble && !ut.isWindow(i)) {
                            for (f = h.delegateType || d, jt.test(f + d) || (u = u.parentNode); u; u = u.parentNode) p.push(u),
                            a = u;
                            a === (i.ownerDocument || $) && p.push(a.defaultView || a.parentWindow || e)
                        }
                        for (o = 0;
                        (u = p[o++]) && !n.isPropagationStopped();) n.type = o > 1 ? f : h.bindType || d,
            ...
            handlers: function (e, n) {
                ...
                if (a && f.nodeType && (!e.button || "click" !== e.type)) for (; f != this; f = f.parentNode || this) if (f.disabled !== !0 || "click" !== e.type) {
                        for (i = [], r = 0; a > r; r++) o = n[r],
                        s = o.selector + " ",
                        i[s] === t && (i[s] = o.needsContext ? ut(s, this).index(f) >= 0 : ut.find(s, this, null, [f]).length),
                        i[s] && i.push(o);
                        i.length && u.push({
                            elem: f,
                            handlers: i
            ...
            fix: function (e) {
                ...
                for (e = new ut.Event(r), t = s.length; t--;) n = s[t],
                e[n] = r[n];
            ...
            mouseHooks: {
                ...
                filter: function (e, n) {
                    var r, i, s, o = n.button,
                        u = n.fromElement;
                    return null == e.pageX && null != n.clientX && (r = e.target.ownerDocument || $, i = r.documentElement, s = r.body, e.pageX = n.clientX + (i && i.scrollLeft || s && s.scrollLeft || 0) - (i && i.clientLeft || s && s.clientLeft || 0), e.pageY = n.clientY + (i && i.scrollTop || s && s.scrollTop || 0) - (i && i.clientTop || s && s.clientTop || 0)),
            ...
            ut.event.special[e] = {
                ...
                handle: function (e) {
                    var n, r = this,
                        i = e.relatedTarget,
                        s = e.handleObj;
                    return (!i || i !== r && !ut.contains(r, i)) && (e.type = s.origType, n = s.handler.apply(this, arguments), e.type = t),
                    n
                }
            }
        }),
    ...
    function (e, t) {
                ...
                if (!D && !r) {
                    if (i = vt.exec(e)) if (o = i[1]) {
                        if (9 === u) {
                            ...
                            n
                        } else if (t.ownerDocument && (s = t.ownerDocument.getElementById(o)) && j(t, s) && s.id === o) return n.push(s),
                        n
                    } else {
                        if (i[2]) return G.apply(n, Y.call(t.getElementsByTagName(e), 0)),
                        n;
                        if ((o = i[3]) && R.getByClassName && t.getElementsByClassName) return G.apply(n, Y.call(t.getElementsByClassName(o), 0)),
                        n
                    }
                    if (R.qsa && !P.test(e)) {
                        ...
                        if (v) try {
                            return G.apply(n, Y.call(d.querySelectorAll(v), 0)),
                            n
                        } catch (m) {} finally {
            ...
            function m(e, t, n, r, s, o) {
                ...
                i(function (i, o, u, a) {
                    ...
                    if (i) {
                        ...
                        } else y = v(y === o ? y.splice(d, y.length) : y),
            ...
            function w(e, t, n, r) {
                ...
                if (!r && 1 === f.length) {
                    ...
                    for (i = ht.needsContext.test(e) ? -1 : s.length - 1; i >= 0 && (o = s[i], !T.relative[u = o.type]); i--) if ((a = T.find[u]) && (r = a(o.matches[0].replace(wt, Et), pt.test(s[0].type) && t.parentNode || t))) {
                        if (s.splice(i, 1), e = r.length && h(s), !e) return G.apply(n, Y.call(r, 0)),
                        n;
                        break
                    }
                }
                return k(e, f)(r, t, D, n, pt.test(e)),
                n
            }
            function E() {}
            ...
            O = o.setDocument = function (e) {
                    ...
                    return r !== M && 9 === r.nodeType && r.documentElement ? (M = r, _ = r.documentElement, D = C(r), R.tagNameNoComments = s(function (e) {
                        ...
                        return R.getIdNotName = !r.getElementById(I),
                        _.removeChild(e),
                        t
            ...
            T = o.selectors = {
                    ...
                    filter: {
                        ...
                        PSEUDO: function (e, t) {
                            ...
                            return r[I] ? r(t) : r.length > 1 ? (n = [e, e, "", t], T.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function (e, n) {
                                for (var i, s = r(e, t), o = s.length; o--;) i = Z.call(e, s[o]),
                                e[i] = !(n[i] = s[o])
                            }) : function (e) {
                                return r(e, 0, n)
                            }) : r
                    ...
                    pseudos: {
                        ...
                        lang: i(function (e) {
                            return ct.test(e || "") || o.error("unsupported lang: " + e),
            ...
            k = o.compile = function (e, t) {
                    var n, r = [],
                        ...
                        s = V[e + " "];
                    if (!s) {
                            for (t || (t = c(e)), n = t.length; n--;) s = g(t[n]),
    ...
    ut.fn.extend({
            find: function (e) {
                ...
                return n = this.pushStack(ut.unique(n)),
    ...
    ut.extend({
            ...
            dir: function (e, n, r) {
                for (var i = [], s = e[n]; s && 9 !== s.nodeType && (r === t || 1 !== s.nodeType || !ut(s).is(r));) 1 === s.nodeType && i.push(s),
                s = s[n];
                return i
            },
    ...
    ut.fn.extend({
            ...
            domManip: function (e, n, r) {
                ...
                if (c && (i = ut.buildFragment(e, this[0].ownerDocument, !1, this), s = i.firstChild, 1 === i.childNodes.length && (i = s), s)) {
                        for (n = n && ut.nodeName(s, "tr"), o = ut.map(b(i, "script"), d), u = o.length; c > l; l++) a = i,
                        l !== m && (a = ut.clone(a, !0, !0), u && ut.merge(o, b(a, "script"))),
                        r.call(n && ut.nodeName(this[l], "table") ? p(this[l], "tbody") : this[l], a, l);
                        if (u) for (f = o[o.length - 1].ownerDocument, ut.map(o, v), l = 0; u > l; l++) a = o[l],
                        tn.test(a.type || "") && !ut._data(a, "globalEval") && ut.contains(f, a) && (a.src ? ut.ajax({
                            url: a.src,
                            type: "GET",
                            dataType: "script",
                            async: !1,
    ...
    ut.each({
            ...
            ut.fn[e] = function (e) {
                for (var n, r = 0, i = [], s = ut(e), o = s.length - 1; o >= r; r++) n = r === o ? this : this.clone(!0),
                ut(s[r])[t](n),
                tt.apply(i, n.get());
    ...
    ut.extend({
            ...
            css: function (e, n, r, i) {
                var s, o, u, a = ut.camelCase(n);
                return n = ut.cssProps[a] || (ut.cssProps[a] = E(e.style, a)),
    ...
    e.getComputedStyle ? (fn = function (t) {
            ...
            var i, s, o, u = r || fn(e),
                ...
                f = e.style;
            return u && ("" !== a || ut.contains(e.ownerDocument, e) || (a = ut.style(e, n)), gn.test(a) && vn.test(n) && (i = f.width, s = f.minWidth, o = f.maxWidth, f.minWidth = f.maxWidth = f.width = a, a = u.width, f.width = i, f.minWidth = s, f.maxWidth = o)),
            a
            ...
            gn.test(a) && !pn.test(n) && (i = f.left, s = e.runtimeStyle, o = s && s.left, o && (s.left = e.currentStyle.left), f.left = "fontSize" === n ? "1em" : a, a = f.pixelLeft + "px", f.left = i, o && (s.left = o)),
            "" === a ? "auto" : a
        }),
    ...
    ut.support.opacity || (ut.cssHooks.opacity = {
            ...
            set: function (e, t) {
                ...
                n.zoom = 1,
                (t >= 1 || "" === t) && "" === ut.trim(s.replace(cn, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || r && !r.filter) || (n.filter = cn.test(s) ? s.replace(cn, i) : s + " " + i)
            }
        }),
    ut(function () {
    ...
    ut.each(["get", "post"], function (e, n) {
            ut[n] = function (e, r, i, s) {
                return ut.isFunction(r) && (s = s || i, i = r, r = t),
                ut.ajax({
                    url: e,
                    type: n,
                    dataType: s,
    ...
    ut.ajaxPrefilter("json jsonp", function (n, r, i) {
            ...
            return a || "jsonp" === n.dataTypes[0] ? (s = n.jsonpCallback = ut.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, a ? n[a] = n[a].replace(Vn, "$1" + s) : n.jsonp !== !1 && (n.url += (_n.test(n.url) ? "&" : "?") + n.jsonp + "=" + s), n.converters["script json"] = function () {
                return u || ut.error(s + " was not called"),
                u[0]
    ...
    ut.fx.tick = function () {
            var e, n = ut.timers,
                r = 0;
            for (Gn = ut.now(); n.length > r; r++) e = n[r],
    ...
    ut.fn.offset = function (e) {
            ...
            ut.contains(n, s) ? (s.getBoundingClientRect !== t && (i = s.getBoundingClientRect()), r = W(o), {
...
function () {
    ...
    var u = /\s+/,
        a = i.Events = {
            ...
            off: function (e, t, n) {
                ...
                if (!(e || t || n)) return delete this._callbacks,
                this;
    ...
    s.extend(f.prototype, a, {
            ...
            set: function (e, t, n) {
                var r, i, o;
                s.isObject(e) || e == null ? (r = e, n = t) : (r = {}, r[e] = t),
                n || (n = {});
                if (!r) return this;
                ...
                for (i in r) {
                        o = r[i];
                        if (!s.isEqual(a[i], o) || n.unset && s.has(a, i)) delete l[i],
                        (n.silent ? this._silent : u)[i] = !0;
                        n.unset ? delete a[i] : a[i] = o,
                        !s.isEqual(c[i], o) || s.has(a, i) != s.has(c, i) ? (this.changed[i] = o, n.silent || (this._pending[i] = !0)) : (delete this.changed[i], delete this._pending[i])
                    }
    ...
    s.extend(l.prototype, a, {
            ...
            add: function (e, t) {
                ...
                for (n = 0, o = e.length; n < o; n++)(u = e[n]).on("all", this._onModelEvent, this),
                this._byCid[u.cid] = u,
    ...
    s.extend(h.prototype, a, {
            ...
            route: function (e, t, n) {
                return i.history || (i.history = new m),
            ...
            _routeToRegExp: function (e) {
                return e = e.replace(v, "\\$&").replace(p, "([^/]+)").replace(d, "(.*?)"),
                new RegExp("^" + e + "$")
            },
    ...
    s.extend(m.prototype, a, {
            ...
            start: function (e) {
                ...
                this._hasPushState ? o(window).bind("popstate", this.checkUrl) : this._wantsHashChange && "onhashchange" in window && !r ? o(window).bind("hashchange", this.checkUrl) : this._wantsHashChange && (this._checkUrlInterval = setInterval(this.checkUrl, this.interval)),
                this.fragment = t;
                var i = window.location,
                    u = i.pathname == this.options.root;
                if (this._wantsHashChange && this._wantsPushState && !this._hasPushState && !u) return this.fragment = this.getFragment(null, !0),
...
define("text", ["module"], function (e) {
    ...
    if (c.env === "node" || !c.env && typeof process != "undefined" && process.versions && !! process.versions.node) n = require.nodeRequire("fs"),
    t.get = function (e, t) {
...
function (e) {
    ...
    i.prototype = {
            ...
            keydown: function (t) {
                ...
                u = n(i),
                a = u.hasClass("open");
                if (!a || a && t.keyCode == 27) return t.which == 27 && u.find(r).focus(),
                i.click();
                s = e("[role=menu] li:not(.divider):visible a", u);
                if (!s.length) return;
                f = s.index(s.filter(":focus")),
                t.keyCode == 38 && f > 0 && f--,
                t.keyCode == 40 && f < s.length - 1 && f++,
                ~f || (f = 0),
                s.eq(f).focus()
            }
        };
...
define("views/snippet", ["jquery", "underscore", "backbone", "text!templates/popover/popover-main.html", "text!templates/popover/popover-input.html", "text!templates/popover/popover-select.html", "text!templates/popover/popover-textarea.html", "text!templates/popover/popover-textarea-split.html", "text!templates/popover/popover-checkbox.html", "templates/snippet/snippet-templates", "bootstrap"], function (e, t, n, r, i, s, o, u, a, f) {
    ...
    return r.extend({
        ...
        mouseDownHandler: function (t) {
            ...
            this.model.get("title") !== "Form Name" && e("body").on("mousemove", function (e) {
                if (Math.abs(t.pageX - e.pageX) > 10 || Math.abs(t.pageY - e.pageY) > 10) n.$el.popover("destroy"),
...
define("collections/my-form-snippets", ["jquery", "underscore", "backbone", "models/snippet", "collections/snippets", "views/my-form-snippet"], function (e, t, n, r, i, s) {
    return i.extend({
        ...
        giveUniqueId: function (e) {
            ...
            typeof this.counter[t] == "undefined" ? this.counter[t] = 0 : this.counter[t] += 1,
            e.setField("id", t + "-" + this.counter[t]),
            typeof e.get("fields")["id2"] != "undefined" && e.setField("id2", t + "2-" + this.counter[t])
        },
...
define("views/tab", ["jquery", "underscore", "backbone", "text!templates/app/tab-nav.html"], function (e, t, n, r) {
    return n.View.extend({
        ...
        render: function () {
            ...
            e("#formtabs").append(this.tabNavTemplate({
